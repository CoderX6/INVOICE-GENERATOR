...
function App() {
  ...
  initialTime.setHours(10, 15, 22); // Set to 10:15:22

  const [hours, sethours] = useState(initialTime);

  const incrementTime = () => {
    const randomSeconds = Math.floor(Math.random() * 5) + 1; // Random number between 1 and 5
